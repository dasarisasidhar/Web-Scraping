...
def get_data():
    ...
    browser.get("https://www.facebook.com/Telyportinc/manage_jobs/?source=manage_jobs_tab")
    time.sleep(2)
    browser.find_element_by_id("email").send_keys("7416861404")
    browser.find_element_by_id("pass").send_keys("Sasi@12345")
    time.sleep(2)
